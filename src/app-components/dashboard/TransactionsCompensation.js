...
export default function TransactionsCompensation() {
                ...
                <tbody>
                  <tr>
                    <td className="text-center text-black-30">
                      <span className="font-weight-bold">0125698</span>
                    </td>
                    <td className="text-center text-black-30">
                  ...
                  <tr>
                    <td className="text-center text-black-30">
                      <span className="font-weight-bold">1782200</span>
                    </td>
                    <td className="text-center text-black-30">
                      <span className="font-weight-bold">17-05-2020 12:10</span>
                    </td>
                    <td className="text-center">
                      <div>
                        <a
